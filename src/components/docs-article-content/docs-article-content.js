...
export default class DocsArticleContent extends Component {
    ...
    render() {
        ...
        this.props.data.article_content.forEach((block, counter) => {
            ...
            Object.keys(this.blockMap).forEach((blockType) => {

                // Check for a match in Block Types.
                if (block[blockType]) {
                    // Add section to page and pass it props.
                    pageSections.push(React.createElement(this.blockMap[blockType], { key: "block-" + counter, data: block[blockType] }, null))
                    // Add Section to Nav
        ...
        return (
            <div className="docs-page padding-both">
